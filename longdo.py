#######################################################################################
# FirstName/Surname: Chirakan Jaisiri
# Student ID: 64070130
...
accessToken = "Bearer MmIyNzBmMWYtMTUzMy00NmNhLTg5YzktZjEyNGI5ODEyYzEyMjAzZTBlZjAtMjhk_P0A1_8cdfd0ff-2397-4f58-80c4-22a9738c4555" 

#######################################################################################
# 3. Prepare GetParameters to get the latest message for messages API.

# Defines a variable that will hold the roomId 
roomIdToGetMessages = "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vYWZkZWUyMzAtZGM3OC0xMWVlLTk4MTktZTFjN2ZmNmY0MGMw"  #test Room
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        # - "limit" is always 1
        # - "key" is the openweather API key, https://home.openweathermap.org/api_keys password M.%j8-25!P*$WX^ 
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "36e3bcb163d4d0f4c7d3d1b2121933fd",
        }
#######################################################################################       
